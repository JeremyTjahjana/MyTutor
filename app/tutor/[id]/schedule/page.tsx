...
export default function SchedulePage() {
  ...
  const confirmationHref = selectedTime
    ? `/tutor/${tutorId}/confirmation?${new URLSearchParams({
        matkul: tutor.matkuls[activeMatkul] ?? "",
        hari: selectedTime.hari,
        jamMulai: selectedTime.jamMulai,
        jamSelesai: selectedTime.jamSelesai,
        tanggal: selectedTime.tanggal,
      }).toString()}`
    : undefined;
