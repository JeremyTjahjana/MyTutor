...
export default function TutorDashboardLayout({
  ...
  const pageTitle = activeItem?.label ?? "Tutor dashboard";
    ...
    return (
      <div className="flex min-h-[100dvh] items-center justify-center bg-[var(--putih)] px-4">
        <div className="max-w-md text-center">
          <p className="text-[var(--gelap)]/70 mb-4">
            You do not have access to the tutor dashboard.
          </p>
          <Link
            href="/"
      ...
      <div className="flex min-h-[calc(100dvh-3.5rem)] flex-1 lg:min-h-[100dvh]">
        ...
        <aside className="relative hidden w-[280px] shrink-0 flex-col border-r border-[var(--gelap)]/10 bg-white lg:flex">
          ...
          <div className="absolute bottom-0 left-0 right-0 border-t border-[var(--gelap)]/10 bg-white p-4">
            ...
            <Link
              href="/tutor-dashboard/profile"
              className="mt-3 block text-center text-xs font-medium text-[var(--biru)] hover:underline"
            >
