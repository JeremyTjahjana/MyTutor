...
import { signupStudentAction, type SignupState } from "@/app/server/actions/auth.action";
  ...
  return (
    <AuthLayout mode="signup">
      ...
      <div className="my-5 flex items-center gap-3">
        ...
        <span className="text-xs font-medium text-[var(--gelap)]/35">atau daftar dengan email</span>
        <div className="h-px flex-1 bg-[var(--gelap)]/[0.08]" />
      </div>
